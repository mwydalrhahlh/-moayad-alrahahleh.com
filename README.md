# الموقع الرسمي للخبير المحامي مؤيد يحيى الرحاحله
...
ضع الصورة الشخصية باسم `assets/profile.jpg` حتى تظهر في القسم الرئيسي.

## التقنيات المستخدمة

- **Tailwind CSS** (CDN) - إطار عمل CSS
- **FontAwesome** - أيقونات
- **Google Fonts** (Cairo) - خط عربي هندسي فخم
...
# إنشاء أول commit
git commit -m " initial commit - الموقع الرسمي للخبير المحامي مؤيد يحيى الرحاحله"
